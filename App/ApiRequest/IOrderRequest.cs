...
public interface IOrderRequest
{
    ...
    Task<IEnumerable<Order>?> GetOrdersByDateRangeAsync(Api.Core.Helper.DateRange dateRange);
    Task<IEnumerable<Order>?> GetOrdersByTotalPriceRangeAsync(Api.Core.Helper.DoubleRange priceDoubleRange);
