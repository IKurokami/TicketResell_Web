...
import { Award, Calendar, Clock, CreditCard, MapPin, MessageSquare, Star, ThumbsUp, Ticket } from "lucide-react";
...
const TicketCard : React.FC<{ ticket: any; onCardClick: any }> = ({ ticket, onCardClick }) => {
  ...
  const handleSubmitRating = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/Rating/create`, {
        method: "POST",
        credentials:"include",
        headers: {
        ...
        <CardContent className="p-0">
          <div className="relative overflow-hidden">
            ...
            <button
              ...
              className="absolute right-4 bottom-4 p-2 rounded-full hover:bg-white/10 transition-colors z-10"
            >
