                    ...
                    <div className="flex space-x-2">
                      ...
                      >
                        <svg
                          ...
                          className="h-4 w-4 text-blue-600" // Adjust size as needed
                          viewBox="0 0 512 512" // Set the viewBox to fit the icon dimensions
                          fill="currentColor"
                        >
                      ...
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-4 w-4 text-red-600" // Adjust size as needed
                          fill="currentColor"
                          viewBox="0 0 448 512" // Adjusted viewBox to match icon size
                        >
                          <path
