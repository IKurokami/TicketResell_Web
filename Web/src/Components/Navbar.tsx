        ...
        >
            ...
            <div className="user-section">
                ...
                <div className="user-dropdown-wrapper relative">
                    {isLoggedIn && (
                        <button onClick={toggleDropdown} aria-label="User" className="focus:outline-none">
                            <img
                    ...
                    {isDropdownVisible && (
                        <div
                            className="user-dropdown visible absolute right-0 mt-2 w-48 rounded-2xl bg-white shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                            <div className="py-1">
                                <a
                                    href="#"
                                ...
                                >
                                    <div className="flex items-center">
                                        <svg className="w-4 h-4 mr-2 text-red-500" fill="none" stroke="currentColor"
                                             viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
