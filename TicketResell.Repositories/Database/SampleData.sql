...
VALUES 
('USER001', 'SELLCONFIG001', 'user1', 'hashed_password1', 1, GETDATE(), 'user1@gmail.com', 'User One', 'Male', '1111111111', 'Address 1', '/avatars/avatar1', '1990-01-01', 'Bio of user one', 1, 'Bank A', 'Checking', 'Sell Address 1', 'CCCD001'),

('USER002', 'SELLCONFIG002', 'user2', 'hashed_password2', 1, GETDATE(), 'user2@gmail.com', 'User Two', 'Female', '2222222222', 'Address 2', '/avatars/avatar2', '1992-02-02', 'Bio of user two', 0, 'Bank B', 'Savings', 'Sell Address 2', 'CCCD002'),

('USER003', 'SELLCONFIG003', 'user3', 'hashed_password3', 1, GETDATE(), 'user3@gmail.com', 'User Three', 'Male', '3333333333', 'Address 3', '/avatars/avatar3', '1993-03-03', 'Bio of user three', 1, 'Bank C', 'Checking', 'Sell Address 3', 'CCCD003'),

('USER004', 'SELLCONFIG004', 'user4', 'hashed_password4', 1, GETDATE(), 'user4@gmail.com', 'User Four', 'Female', '4444444444', 'Address 4', '/avatars/avatar4', '1994-04-04', 'Bio of user four', 1, 'Bank D', 'Savings', 'Sell Address 4', 'CCCD004'),

('USER005', 'SELLCONFIG005', 'user5', 'hashed_password5', 0, GETDATE(), 'user5@gmail.com', 'User Five', 'Male', '5555555555', 'Address 5', '/avatars/avatar5', '1995-05-05', 'Bio of user five', 0, 'Bank E', 'Checking', 'Sell Address 5', 'CCCD005'),

('USER006', 'SELLCONFIG006', 'user6', 'hashed_password6', 0, GETDATE(), 'user6@gmail.com', 'User Six', 'Female', '6666666666', 'Address 6', '/avatars/avatar6', '1996-06-06', 'Bio of user six', 1, 'Bank F', 'Savings', 'Sell Address 6', 'CCCD006'),

('USER007', 'SELLCONFIG007', 'user7', 'hashed_password7', 1, GETDATE(), 'user7@gmail.com', 'User Seven', 'Male', '7777777777', 'Address 7', '/avatars/avatar7', '1997-07-07', 'Bio of user seven', 1, 'Bank G', 'Checking', 'Sell Address 7', 'CCCD007'),

('USER008', 'SELLCONFIG008', 'user8', 'hashed_password8', 1, GETDATE(), 'user8@gmail.com', 'User Eight', 'Female', '8888888888', 'Address 8', '/avatars/avatar8', '1998-08-08', 'Bio of user eight', 1, 'Bank H', 'Savings', 'Sell Address 8', 'CCCD008'),

('USER009', 'SELLCONFIG009', 'user9', 'hashed_password9', 0, GETDATE(), 'user9@gmail.com', 'User Nine', 'Male', '9999999999', 'Address 9', '/avatars/avatar9', '1999-09-09', 'Bio of user nine', 0, 'Bank I', 'Checking', 'Sell Address 9', 'CCCD009'),

('USER010', 'SELLCONFIG010', 'user10', 'hashed_password10', 1, GETDATE(), 'user10@gmail.com', 'User Ten', 'Female', '1010101010', 'Address 10', '/avatars/avatar10', '2000-10-10', 'Bio of user ten', 1, 'Bank J', 'Savings', 'Sell Address 10', 'CCCD010');
