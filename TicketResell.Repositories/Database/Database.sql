...
BEGIN
    CREATE TABLE [Chat] (
        ...
        CONSTRAINT [PK_Chat] PRIMARY KEY ([SenderId], [ReceiverId]),
        CONSTRAINT [FK_Chat_Receiver] FOREIGN KEY ([ReceiverId]) REFERENCES [User] ([UserId]),
        CONSTRAINT [FK_Chat_Sender] FOREIGN KEY ([SenderId]) REFERENCES [User] ([UserId])
    );
END;
GO
...
BEGIN
    ...
    IF @var2 IS NOT NULL EXEC(N'ALTER TABLE [Chat] DROP CONSTRAINT [' + @var2 + '];');
...
BEGIN
    CREATE TABLE [Rating] (
        ...
        CONSTRAINT [PK__Rating__FCCDF87C6FC41DB2] PRIMARY KEY ([RatingId]),
        CONSTRAINT [FK_Rating_Seller] FOREIGN KEY ([SellerId]) REFERENCES [User] ([UserId]) ON DELETE SET NULL,
