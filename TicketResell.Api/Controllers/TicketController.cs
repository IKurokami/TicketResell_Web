//using AutoMapper;
//using Api.Core.Dtos.Ticket;
//using Api.Core.Entities;
//using Api.Core.Validators;
//using Api.Repositories;
//using Api.Repositories.Tickets;
...
//        {
//            var validatorTicket = _validatorFactory.GetValidator<Api>();
//            Ticket newTicket = _mapper.Map<Api>(dto);
...
//            var validator = _validatorFactory.GetValidator<Api>();
