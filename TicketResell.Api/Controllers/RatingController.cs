...
namespace Api.Controllers
{
    ...
    public class RatingController : ControllerBase
    {
        ...
        {
            if (!HttpContext.GetIsAuthenticated())
                return ResponseParser.Result(ResponseModel.Unauthorized("You need to be authenticated to update a rating."));
        ...
        {
            if (!HttpContext.GetIsAuthenticated())
                return ResponseParser.Result(ResponseModel.Unauthorized("You need to be authenticated to delete a rating."));
